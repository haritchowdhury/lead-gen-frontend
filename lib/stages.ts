const STAGE_LABELS: Record<string, string> = {
  ...
  stores_persisted: "Stores saved — preparing contact discovery",
  discovering_leads: "Finding and saving contact details",
  leads_persisted: "Leads saved — preparing traffic analysis",
  enriching_traffic: "Adding traffic insights",
